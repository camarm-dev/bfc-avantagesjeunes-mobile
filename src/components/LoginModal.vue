          ...
          <ion-item class="ion-border">
            <ion-checkbox color="secondary" justify="start" :checked="agree" @ionChange="changeAgreeStatus($event.detail.checked)" label-placement="end" required>
              <ion-label class="ion-text-wrap" color="light">
                J'accepte les <a href="https://avantagesjeunesconnect.camarm.fr/cgu" target="_blank">conditions générales d'utilisation</a> ainsi que <a href="https://avantagesjeunesconnect.camarm.fr/privacy" target="_blank">la politique de confidentialité</a> de Avantages Jeunes Connect et j'ai pris connaissance du
