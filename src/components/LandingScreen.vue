      ...
      >
          ...
          <div class="text fullwidth">
            <ion-list class="fullwidth">
              <ion-item class="ion-border fullwidth large">
                <ion-input :value="password" @ionInput="password = $event.detail.value as string" type="password" placeholder="Entrez votre code de connexion"/>
              </ion-item>
            </ion-list>
          </div>
          <div class="bottom-container">
        ...
        <swiper-slide v-if="firstConnection">
          <div>
            ...
            <div class="subtitle">
              Ceci est votre première connexion, vous devez donc changer votre mot de passe...
            </div>
          </div>
          <div class="text fullwidth">
  ...
  methods: {
    ...
    async login () {
      ...
      if (checkFirstConnection.status) {
        ...
        const accountData: FinishSigningData = {
          adresse: data.carte.adresse,
          cp: data.carte.cp,
          date_naiss: data.carte.date_naiss,
          email: data.carte.email,
          emailConfirm: data.carte.email,
          emailNew: data.carte.email,
          email_accepte: false,
        ...
        await finishAccountCreation(this.cardID, accountData)
      } else {
